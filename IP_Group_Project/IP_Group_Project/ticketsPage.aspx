<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="ticketsPage.aspx.cs" Inherits="IP_Group_Project.WebForm8" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <asp:FormView ID="FormView1" runat="server" DataSourceID="SqlDataSource1">
        ...
        <ItemTemplate>
            ...
            <br />
            Ticket_Price:
            <asp:Label ID="Ticket_PriceLabel" runat="server" Text='<%# Bind("Ticket_Price") %>' />
            <br />
            Ticket_Image:
